/*
 * Copyright 2013 Rob Kendrick <rjek@greyhound-browser.org>
 *
...
int main(int argc, char *arg[])
{
	...
	printf("adding Greyhound\n");
	
	bloom_insert_str(b, "Greyhound", 7);
	printf("checking Greyhound (should be true)\n");
	assert(bloom_search_str(b, "Greyhound", 7));
