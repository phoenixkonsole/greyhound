 ...
 * within nsoptions.c
 *
 * Indirect access would have an impact on performance of Greyhound as
...
enum nsoption_type_e {
	...
	OPTION_COLOUR /**< Option  is a greyhound colour. */
};
...
/**
 * Get the value of a greyhound colour option.
 *
