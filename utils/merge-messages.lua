...
local en_stat = assert(lfs.attributes "!Greyhound/Resources/en/Messages")
local language = { }
local sorted = { }

io.stderr:write("loading non-en languages...\n");

for dir in lfs.dir "!Greyhound/Resources" do
   local path = "!Greyhound/Resources/" .. dir
...
local f = io.open("!Greyhound/Resources/en/Messages", "r")
