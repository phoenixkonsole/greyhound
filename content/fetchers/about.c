/*
 * Copyright 2011 Vincent Sanders <vince@greyhound-browser.org>
 *
...
static bool fetch_about_imagecache_handler(struct fetch_about_context *ctx)
{
	...
	slen = snprintf(buffer, sizeof buffer, 
			"<html>\n<head>\n"
			"<title>Greyhound Browser Image Cache Status</title>\n"
			"<link rel=\"stylesheet\" type=\"text/css\" "
			"href=\"resource:internal.css\">\n"
			"</head>\n"
			"<body id =\"cachelist\">\n"
			"<p class=\"banner\">"
			"<a href=\"http://www.greyhound-browser.org/\">"
			"<img src=\"resource:greyhound.png\" alt=\"Greyhound\"></a>"
			"</p>\n"
			"<h1>Greyhound Browser Image Cache Status</h1>\n"	);
...
static bool fetch_about_config_handler(struct fetch_about_context *ctx)
{
	...
	slen = snprintf(buffer, sizeof buffer, 
			"<html>\n<head>\n"
			"<title>Greyhound Browser Config</title>\n"
			"<link rel=\"stylesheet\" type=\"text/css\" "
			"href=\"resource:internal.css\">\n"
			"</head>\n"
			"<body id =\"configlist\">\n"
			...
			"<img src=\"resource:greyhound.png\" alt=\"Greyhound\"></a>"
			"</p>\n"
			"<h1>Greyhound Browser Config</h1>\n"
			"<table class=\"config\">\n"
...
static bool fetch_about_choices_handler(struct fetch_about_context *ctx)
{
	...
	slen = snprintf(buffer, sizeof buffer, 
		 "# Automatically generated current Greyhound browser Choices\n");
...
static bool fetch_about_testament_handler(struct fetch_about_context *ctx)
{
	...
	slen = snprintf(buffer, sizeof buffer, 
		 "# Automatically generated by Greyhound build system\n\n");
	...
	slen = snprintf(buffer, sizeof buffer, 
			...
			"# This is a tagged build of Greyhound\n"
#ifdef WT_TAGIS
			...
			"# This Greyhound was built outside of our revision "
			"control environment.\n"
			"# This testament is therefore very useful.\n\n"
#else
			"# This Greyhound was built from a branch (" WT_BRANCHPATH ").\n\n"
#endif
#if defined(CI_BUILD)
...
static bool fetch_about_logo_handler(struct fetch_about_context *ctx)
{
	...
	msg.type = FETCH_REDIRECT;
	msg.data.redirect = "resource:greyhound.png";
...
static bool fetch_about_about_handler(struct fetch_about_context *ctx)
{
	...
	slen = snprintf(buffer, sizeof buffer, 
			"<html>\n<head>\n"
			"<title>Greyhound List of About pages</title>\n"
			"<link rel=\"stylesheet\" type=\"text/css\" "
			"href=\"resource:internal.css\">\n"
			"</head>\n"
			"<body id =\"aboutlist\">\n"
			...
			"<img src=\"resource:greyhound.png\" alt=\"Greyhound\"></a>"
			"</p>\n"
			"<h1>Greyhound List of About pages</h1>\n"
			"<ul>\n");
