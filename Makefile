#
# Makefile for Greyhound
#
# Copyright 2007 Daniel Silverstone <dsilvers@greyhound-browser.org>
# Copyright 2008 Rob Kendrick <rjek@greyhound-browser.org>
#
# Trivially, invoke as:
#   make
# to build native, or:
...
ifeq ($(TARGET),beos)
	...
	$(Q)$(BEOS_SETVER) $(EXETARGET) \
                ...
                -short "Greyhound $(VERSION_FULL)" \
                -long "Greyhound $(VERSION_FULL) © 2003 - 2013 The Greyhound Developers"
...
!Greyhound/Resources/$(1)/Templates$$(TPLEXT): $(2)
	$$(VQ)echo "TEMPLATE: $(2)"
	$$(Q)mkdir -p !Greyhound/Resources/$(1)
...
clean-target:
	...
	$(Q)$(RM) $(EXETARGET)
	$(call clean_install_messages, !Greyhound/Resources)
...
all-program: $(EXETARGET) post-exe
	$(call split_install_messages, any, !Greyhound/Resources)
