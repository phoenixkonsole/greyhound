/*
 * Copyright 2011 John-Mark Bell <jmb@greyhound-browser.org>
 *
 ...
 *
 * This cache allows greyhound to use a generic intermediate bitmap
 * format without keeping the
 * intermediate representation in memory.
 *
 * The bitmap structure is opaque to the rest of greyhound and is
