...
/**
 * Convert a CSS color to a Greyhound colour primitive
 *
 * ARGB -> (1-A)BGR
 *
 * \param color  The CSS color to convert
 * \return Corresponding Greyhound colour primitive
 */
...
/**
 * Convert a Greyhound color to a CSS colour primitive
 *
 * (1-A)BGR -> ARGB
 *
 * \param color  The Greyhound color to convert
